...
router.post('/cadastro/add',(req,res)=>{
    ...
    //tentei deixar minusculo usando toLowerCase mas por alguma razão aparece vazio na lista, e salva como Function: toLowerCase
    ...
    //res.sendStatus(200); //comentar aqui para ver se para o erro que manda "duplicado". acho que é isso
    res.status(200).json({
        status:'sucess',
